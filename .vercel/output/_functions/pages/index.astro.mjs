...
const $$WhatsappButton = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- Chat Button with WhatsApp Number Selector -->${maybeRenderHead()}<div class="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50" data-astro-cid-atck4qn2> <!-- Main Chat Button --> <button id="chatToggle" class="fixed bottom-4 right-4 md:bottom-6 md:right-6 bg-white hover:bg-white text-white p-2 md:p-3 rounded-full shadow-lg transition-transform transform hover:scale-105" data-astro-cid-atck4qn2> ${renderComponent($$result, "Icon", $$Icon, { "name": "whatsapp", "class:list": "text-green-600", "data-astro-cid-atck4qn2": true })} </button> <!-- Dropdown Menu for WhatsApp Numbers --> <div id="chatOptions" class="hidden absolute bottom-16 md:bottom-20 right-0 bg-white rounded-xl shadow-lg p-4 space-y-2 w-56 md:w-64" data-astro-cid-atck4qn2> <p class="text-gray-700 font-semibold text-center" data-astro-cid-atck4qn2>¿Con quién deseas hablar?</p> <a href="https://wa.me/56979044361" target="_blank" class="flex items-center p-2 rounded-lg hover:bg-gray-100 transition" data-astro-cid-atck4qn2> <span class="text-green-600 text-xl" data-astro-cid-atck4qn2> ${renderComponent($$result, "Icon", $$Icon, { "name": "tool", "class:list": "text-green-600", "data-astro-cid-atck4qn2": true })} </span> <span class="ml-3 text-gray-800" data-astro-cid-atck4qn2>Soporte Clientes</span> </a> <a href="https://wa.me/56946441506" target="_blank" class="flex items-center p-2 rounded-lg hover:bg-gray-100 transition" data-astro-cid-atck4qn2> <span class="text-green-600 text-xl" data-astro-cid-atck4qn2> ${renderComponent($$result, "Icon", $$Icon, { "name": "chat", "class:list": "text-green-600", "data-astro-cid-atck4qn2": true })} </span> <span class="ml-3 text-gray-800" data-astro-cid-atck4qn2>Atención al Cliente</span> </a> </div> </div>  ${renderScript($$result, "/Users/sebaprogrammer/Desktop/proyectos/kreadium/src/components/buttons/WhatsappButton.astro?astro&type=script&index=0&lang.ts")}`;
